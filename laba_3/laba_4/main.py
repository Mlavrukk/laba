from tree import Comment, get_dataset 
...
def GetDatasetPath():
    ...
    '''
    path = ("C:\\Users\\marGO.LAPTOP-CEGVK39N\\laba\\dataset")
    return path
...
if __name__ == '__main__':
    ...
    print('\nДля оценки 1:\n')
    print('Минимальное количество слов:', stat_1['min'])
    print('Максимальное количество слов:', stat_1['max'])
    print('Среднее количество слов:', stat_1['mean'])
